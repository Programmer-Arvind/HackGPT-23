...
def home():
    ...
    if request.method == "POST":
        if reply := gpt_get(request.form["Destination"]):
            common_phrases, common_phrases_eng, tourist_places, place_descs, foods, food_descs = reply
            ...
            return render_template("Travel_companion_webpage.html", error=True)
    else:
